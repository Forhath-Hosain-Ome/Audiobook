...
# from CORE_APP.views import extract_text_from_pdf, generate_tts_gtts
...
#             return redirect('View_PDF', pk=doc.pk)
#     else:
#         form = DocumentForm()
#     return render(request, "reader/Add_PDF.html", {"form": form, "errors": form.errors})